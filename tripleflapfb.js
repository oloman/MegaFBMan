 ...
 * Modificación para función Facebook con sprite Megaman
 * @author      oloman
 * @web		 http://www.oloblogger.com
 */

if(typeof(facebookAccount)!="string"||facebookAccount=="")var facebookAccount="http://www.facebook.com";
if(typeof(facebookThisText)!="string"||facebookThisText=="")var facebookThisText=document.URL;
var facebookthislink=null;
...
if(!is_utf8(facebookThisText))facebookThisText=utf8_encode(facebookThisText);
var facebookthislink="http://www.facebook.com/share.php?u="+escape(facebookThisText);
var theBird=document.createElement("a");
theBird.setAttribute("id","theBird");
theBird.setAttribute("href","http://goo.gl/PQWc9");
theBird.setAttribute("target","_blank");
theBird.setAttribute("title","Get this");
theBird.style.cursor="default";
...
theBirdLtweet.setAttribute("href",facebookthislink);
theBirdLtweet.setAttribute("target","_blank");
theBirdLtweet.setAttribute("title","");
...
theBirdLtweet.style.backgroundPosition="-96px -0px";
theBirdLtweet.style.width="87px";
theBirdLtweet.style.height="45px";
...
theBirdLfollow.setAttribute("href",facebookAccount);
theBirdLfollow.setAttribute("title","");
theBirdLfollow.style.backgroundPosition="-96px -45px";
theBirdLfollow.style.width="87px";
theBirdLfollow.style.height="30px";
